...
import com.example.tplabovrecetario.ETipoCategoria;
...
public class ModelReceta {
    ...
    public ModelReceta(String id,String nombre, String instrucciones, List<String> ingredientes, ETipoCategoria tipoCategoria, String linkYoutube, String img) {
        super();
        this.id = id;
        this.nombre = nombre;
